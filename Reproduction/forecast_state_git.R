data_male = readRDS("D:/CSC/GB/Mortality_state_male.rds")
...
# Boosted Lee Carter
source("D:/CSC/GB/R/calculate_expanding.R")
source("D:/CSC/GB/R/GB_Leecarter.R")
...
load("D:/CSC/GB/IJF/data/state/male_mase_lca_fdm_cfdm.RData")
cat("L–C")
...
load("D:/CSC/GB/IJF/data/state/male_mase_lgb.RData")
cat("LightGBM")
...
male_mase_expending_NOshrinkage = readRDS("D:/CSC/GB/IJF/data/state/male_mase_expending_gblc")
male_mase_expending_age_optlamb = readRDS("D:/CSC/GB/IJF/data/state/male_mase_expending_a")
male_mase_expending_state_optlamb = readRDS("D:/CSC/GB/IJF/data/state/male_mase_expending_s")
male_mase_expending_ss = readRDS("D:/CSC/GB/IJF/data/state/male_mase_expending_ss")
